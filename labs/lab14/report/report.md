...
1.  Изучили приведённые в тексте программы server.c и client.c. Взяв данные примеры за образец, написали аналогичные программы, внеся некоторые изменения. Так выглядел наш Makefile (рис. [-@fig:001])

![Makefile](image/1.png){ #fig:001 width=70% }

server.c: (рис. [-@fig:002])

![server.c](image/2.png){ #fig:002 width=70% }

client.c: (рис. [-@fig:003])

![client.c](image/3.png){ #fig:003 width=70% }

client2.c: (рис. [-@fig:004])

![client2.c](image/4.png){ #fig:004 width=70% }

common.h: (рис. [-@fig:005])

![common.h](image/5.png){ #fig:005 width=70% }
