...
1. Написали командный файл, реализующий упрощённый механизм семафоров (рис. [-@fig:001])

![Командный файл](image/1.png){ #fig:001 width=70% }

Запустили командный файл (рис. [-@fig:002])

![Запуск командного файла](image/2.png){ #fig:002 width=70% }

2. Изучили содержимое каталога /usr/share/man/man1 (рис. [-@fig:003])

![Содержимое каталога /usr/share/man/man1](image/3.png){ #fig:003 width=70% }

Реализовали команду man с помощью командного файла (рис. [-@fig:004])

![Командный файл](image/4.png){ #fig:004 width=70% }

Запустили командный файл, посмотрели команду mkdir (рис. [-@fig:005])

![Запуск командного файла](image/5.png){ #fig:005 width=70% }

3. Используя встроенную переменную $RANDOM, написали командный файл, генерирующий случайную последовательность букв латинского алфавита (рис. [-@fig:006])

![Командный файл](image/6.png){ #fig:006 width=70% }

Запуск командного файла (рис. [-@fig:007])

![Запуск файла ко третьему заданию](image/7.png){ #fig:007 width=70% }
