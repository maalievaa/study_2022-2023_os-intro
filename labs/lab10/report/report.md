...
1. Создали каталог backup длля выполнения первого задания, а также файл prog.sh (рис. [-@fig:001])

![Создание файлов](image/1.png){ #fig:001 width=70% }

2. Написали скрипт для первого задания (рис. [-@fig:002])

![Скрипт к первому заданию](image/2.png){ #fig:002 width=70% }

3. Запустили prog.sh, проверили, что всё корректно работает. Создали файл для выполнения второго задания (рис. [-@fig:003])

![Запуск скрипта к первому заданию](image/3.png){ #fig:003 width=70% }

4. Написали скрипт для второго задания (рис. [-@fig:004])

![Скрипт ко второму заданию](image/4.png){ #fig:004 width=70% }

5. Запустили prog1.sh, вывелись введённые нами значения. Создали файл для выполнения третьего задания (рис. [-@fig:005])

![Запуск скрипта ко второму заданию](image/5.png){ #fig:005 width=70% }

6. Написали скрипт для третьего задания (рис. [-@fig:006])

![Скрипт к третьему заданию](image/6.png){ #fig:006 width=70% }

7. Запустили скрипт к третьему заданию, смогли увидеть файлы и директории, права у них (рис. [-@fig:007])

![Запуск скрипта к третьему заданию](image/7.png){ #fig:007 width=70% }

8. Создали файл для четвертого задания. Написали скрипт (рис. [-@fig:008])

![Скрипт к четвертому заданию](image/8.png){ #fig:008 width=70% }

9. Запуск скрипта к четвертому заданию, убедились, что всё корректно работает, отображается количество найденных файлов (рис. [-@fig:009])

![Запуск скрипта к четвертому заданию](image/9.png){ #fig:009 width=70% }
